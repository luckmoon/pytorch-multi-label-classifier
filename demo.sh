...
#
python multi_label_classifier.py --dir "./train/mnist/" --mode "Train" --model "LightenB" --name "train" \
   --batch_size 64 --gpu_ids 0 --input_channel 3 --load_size 144 --input_size 128 --mean [0,0,0] --std [1,1,1] --ratio "[0.94, 0.03, 0.03]" \
   --shuffle --load_thread 8 --sum_epoch 5 --lr_decay_in_epoch 1 --display_port 8900 --validate_ratio 0.1 --top_k "(1,)" --score_thres 0.1 \
   --display_train_freq 20 --display_validate_freq 20 --save_epoch_freq 1  --display_image_ratio 0.2
#
